...
CREATE TABLE IF NOT EXISTS MEDICAL_NEED_UPDATE (
...
ALTER TABLE AID_PACKAGE ADD CREATEDBY VARCHAR(50) NOT NULL;

ALTER TABLE AID_PACKAGE ADD DONORID VARCHAR(48) NOT NULL;
